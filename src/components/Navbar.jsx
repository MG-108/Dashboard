...
const Navbar = () => {
  ...
  //tracking the width of a browser or device
  useEffect(() => {
  ...
  const handleActiveMenu = () => setActiveMenu(!activeMenu); //setActiveMenu((prevActiveMenu) => !prevActiveMenu)}
      ...
      <div className="flex">
        ...
        <TooltipComponent content="Profile" position="BottomCenter">
          ...
          >
            ...
            <p>
              <span className="text-gray-400 text-14 ml-1.5">Hi,</span>
              <span className="text-gray-400 font-bold ml-1 text=14">Flora</span>
            </p>
            <MdKeyboardArrowDown className="text-gray-400 text-14 ml-1" />
          </div>
        </TooltipComponent>
